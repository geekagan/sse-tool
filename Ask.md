...
公共类型对外暴露，但 `exports` 里没有 `"."` 或 `"./types"` 入口。用户无法直接 `import type { SSEOptions } from '@geekagan/sse-toolkit'` 。建议加上：
...
> 文件： docs/superpowers/specs/2026-05-20-@geekagan/sse-toolkit-design.md
